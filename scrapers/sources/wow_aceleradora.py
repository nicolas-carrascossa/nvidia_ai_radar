...
_MODEL = "gpt-4o-mini"
_PORTFOLIO_URL = "https://wow.ac/portfolio/"
_FONTE_ORIGEM = "wow_aceleradora"
...
class WowAceleradoraScraper(BaseScraper):
    ...
    def discover(self) -> list[dict]:
        ...
        if not page:
            print(f"[WowAceleradoraScraper] sem conteudo em {_PORTFOLIO_URL}")
            return []
        ...
        try:
            ...
            print(f"[WowAceleradoraScraper] erro LLM: {e}")
            return []
        ...
        for item in items:
            try:
                ...
                print(f"[WowAceleradoraScraper] erro ao processar item {item}: {e}")
